...
public class PetProvider extends ContentProvider {
    ...
    /* Create a PetDbHelper global variable for instantiation*/
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
                        String sortOrder) {
        /* Getting a database object from dbHelper
        by creating an instance of dbHelper with a SQLite database
         */
        ...
        switch (match) {
            case PETS:
                //TODO LIST
                cursor = readableDatabase.query(PetEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case PETS_ID:
